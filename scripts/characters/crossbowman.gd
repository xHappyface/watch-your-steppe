...
func fire_bolt() -> void:
	var bolt_shot: BoltShot = bolt_shot_scene.instantiate()
	LevelManager.level.add_child(bolt_shot)
	bolt_shot.global_position = global_position
	bolt_shot.rotation = rotation
